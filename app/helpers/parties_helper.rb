module PartiesHelper
  ...
  def timeOfParty
	 timeList = [{"value" => 5,  "text" => "05" }, {"value" => 6, "text" => "06" }, {"value" => 7, "text" => "07" }, 
	  {"value" => 8,  "text" => "08" }, {"value" => 9, "text" => "09" }, {"value" => 10, "text" => "10" },
	  {"value" => 11, "text" => "11" }, {"value" => 12,"text" => "12" }, {"value" => 1, "text" => "01" },
	  {"value" => 2,  "text" => "02" }, {"value" => 3, "text" => "03" }, {"value" => 4,"text" => "04" } ]

	times  = []

    timeList.try(:each) do |t|

    	times.concat([t.value, t.text])

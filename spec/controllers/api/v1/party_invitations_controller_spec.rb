...
describe Api::V1::PartyInvitationsController do
  ...
  #     reservation = PartyReservation.create(:email => non_member_party_invitation.email,
  #                                           :party_id => non_member_party_invitation.party_id)
  #     PartyReservation.should_receive(:new).with(email: non_member_party_invitation.email,
  ...
  #     PartyInvitation.should_receive(:new).with(email: 'test@test.com', inviter_id: "999", party_id: "998").and_return(non_member_party_invitation)
